...
export const GET_BOOSTEDBALANCES = 'BOOSTBALANCES';
export const GET_BOOSTEDBALANCES_RETURNED = 'BOOSTBALANCES_RETURNED';

export const BOOST_STAKE = 'BOOST_STAKE';
export const BOOST_STAKE_RETURNED = 'BOOST_STAKE_RETURNED';
